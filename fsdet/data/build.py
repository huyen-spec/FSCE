...
print("DatasetCatalog._REGISTERED********************************", DatasetCatalog._REGISTERED)
...
def get_detection_dataset_dicts(dataset_names, filter_empty=True):
    ...
    print('LENGTH**********************************',len(dataset_names))
    print("DATASET CATALOG*************************", DatasetCatalog._REGISTERED[dataset_names[0]])
    assert len(dataset_names)
    dataset_dicts = [DatasetCatalog.get(dataset_name) for dataset_name in dataset_names]
    print('DATASET DICTS*******************************', len(dataset_dicts))
...
def build_detection_train_loader(cfg, mapper=None):
    ...
    # pdb.set_trace()
    # print("DTASET DICT ****************************", dataset_dicts)
