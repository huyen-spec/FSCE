...
def _get_emed_fewshot_meta(path="/home/huyen/projects/FSCE"):
...
def _get_emed_fewshot_meta_duy(path="/home/huyen/projects/inside_duy/data/pills/"):
    import pickle as pkl
    name2id = pkl.load(open(path+"name2id_duy.pkl","rb"))
    metadata = {}
    base_classes = [k for k in name2id.keys()]
    novel_classes = base_classes[:5]
...
def _get_builtin_metadata(dataset_name):
    ...
    elif 'vaipe' in dataset_name:
        if 'duy' in dataset_name:
            return _get_emed_fewshot_meta_duy()
        else:
            return _get_emed_fewshot_meta()    
