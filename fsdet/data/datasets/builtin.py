...
from .register_coco import register_coco_instances, register_vaipe_instances
...
# change from default directory
# /home/huyen/projects/huyen/Test1/DATA/coco/train-val-14/

# coco/train2014

_PREDEFINED_SPLITS_COCO = {}
_PREDEFINED_SPLITS_COCO["coco"] = {
    "coco_2014_train": ("/home/huyen/projects/huyen/Test1/DATA/coco/train-val-14/train2014", "coco/annotations/instances_train2014.json"),
    "coco_2014_val": ("/home/huyen/projects/huyen/Test1/DATA/coco/train-val-14/val2014", "coco/annotations/instances_val2014.json"),
...
def register_all_coco(root="datasets"):
    # print("items***********************", _PREDEFINED_SPLITS_COCO.items())
    for dataset_name, splits_per_dataset in _PREDEFINED_SPLITS_COCO.items():
        print("data name********************************", dataset_name)
        print("splits_per_dataset.items()********************************", splits_per_dataset.items())
    ...
    METASPLITS = [
        ("coco_trainval_all", "coco/trainval2014", "cocosplit/datasplit/trainvalno5k.json"),
        ("coco_trainval_base", "/home/huyen/projects/huyen/Test1/DATA/coco/train-val-14/train2014", "cocosplit/datasplit/trainvalno5k.json"),
        ("coco_test_all", "coco/val2014", "cocosplit/datasplit/5k.json"),
        ("coco_test_base", "coco/val2014", "cocosplit/datasplit/5k.json"),
        ("coco_test_novel", "coco/val2014", "cocosplit/datasplit/5k.json"),
    ]
...
_PREDEFINED_SPLITS_VAIPE = {}
# _PREDEFINED_SPLITS_VAIPE["vaipe"] = {"vaipe_train": ("/home/huyen/projects/huypn/FewShotDetection/data/vaipe/train/images", "/home/huyen/projects/huyen/Test1/FSCE/vaipe_dataset/vaipe/annotations/instances_train.json"),
#                                     "vaipe_test": ("/home/huyen/projects/huypn/FewShotDetection/data/vaipe/test/images", "/home/huyen/projects/huyen/Test1/FSCE/vaipe_dataset/vaipe/annotations/instances_test.json")}

_PREDEFINED_SPLITS_VAIPE["vaipe"] = {"vaipe_train": ("/home/huyen/projects/FSCE/vaipe_dataset_huyp/data/test/img/images", "/home/huyen/projects/FSCE/vaipe/annotations/instances_test.json"),
                                    "vaipe_test": ("/home/huyen/projects/FSCE/vaipe_dataset_huyp/data/test/img/images", "/home/huyen/projects/FSCE/vaipe/annotations/instances_test.json")}


_PREDEFINED_SPLITS_VAIPE["vaipe_duy"] = {"vaipe_train_duy": ("/home/huyen/projects/inside_duy/", "/home/huyen/projects/inside_duy/data/pills/data_train/instances_train.json"),
                                    "vaipe_test_duy": ("/home/huyen/projects/inside_duy/", "/home/huyen/projects/inside_duy/data/pills/data_test/instances_test.json")}


def register_all_vaipe(root="datasets"):
    # print("items***********************", _PREDEFINED_SPLITS_COCO.items())
    for dataset_name, splits_per_dataset in _PREDEFINED_SPLITS_VAIPE.items():
        print("data name********************************", dataset_name)
        print("splits_per_dataset.items()********************************", splits_per_dataset.items())
        for key, (image_root, json_file) in splits_per_dataset.items():
            # Assume pre-defined datasets live in `./datasets`.
            register_vaipe_instances(
                key,
                _get_builtin_metadata(dataset_name),   # _get_builtin_metadata("emed")
                os.path.join(root, json_file) if "://" not in json_file else json_file,
                os.path.join(root, image_root),
            )
...
# register_all_coco()
print("THIS IS DATA REGISTERING**********************************************************************")
# register_all_lvis()
