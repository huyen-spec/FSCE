...
def default_argument_parser():
    ...
    parser.add_argument(
        "--config-file",
        # default="configs/VAIPE-detection/faster_drcnn_R_50_FPN_base.yaml",
        # default="configs/COCO/R-101/base_training.yml",
        # default = "configs/VAIPE-detection/faster_rcnn_srgn_R_50_base.yaml",
        default = "configs/VAIPE-detection/faster_rcnn_srgn_R_50_base_batch.yaml",
        metavar="FILE",
        help="path to config file",
    )
    parser.add_argument(
        "--resume",
        # default = "/home/huyen/projects/huyen/Test1/FSCE/FSCE/checkpoints/vaipe/faster_rcnn/R_50_FPN_all/test2705/model_0029999.pth",
        action="store_true",
