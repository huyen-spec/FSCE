...
# /home/huyen/projects/huyen/Test1/DATA
# (base) huyen@huyen-Z590-UD:~/projects/huypn/FewShotDetection/data$ 
import os
  
import sys
sys.path.append('/home/huyen/projects/FSCE/')

# import fsdet.utils.comm as comm
from fsdet.utils import comm as comm
...
class Trainer(DefaultTrainer):
    ...
    def build_evaluator(cls, cfg, dataset_name, output_folder=None):
        ...
        print("outpur_folder****************", output_folder)
        evaluator_list = []
        # pdb.set_trace()
...
def main(args):
    cfg = setup(args)
    # cfg.MODEL.ROI_HEADS.NUM_CLASSES = 246
    # cfg.MODEL.WEIGHTS = '/home/huyen/projects/huyen/Test1/FSCE/test_SRGN/FSCE/checkpoints/vaipe/faster_rcnn/R_50_FPN_all/test2705/model_0029999.pth'
    # cfg.MODEL.BACKBONE.FREEZE =
    # cfg.MODEL.BACKBONE.FREEZE_P5 =
    # cfg.MODEL.PROPOSAL_GENERATOR.FREEZE = 
    print("CONFIGS*************", cfg)
    # args.eval_only = True
    if args.eval_only:
